...
const NavBar = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mobile menu */}
      <div 
        className={`md:hidden glass backdrop-blur-md absolute top-full left-0 w-full overflow-hidden transition-all duration-300 ease-in-out ${
      ...
      >
        <div className="flex flex-col py-4 px-4">
          <Link 
            to="/" 
            className={`py-3 px-4 ${isActive('/') ? 'text-tekOrange font-semibold' : ''} dark:text-gray-200 hover:bg-white/10 transition-colors rounded-md`}
          ...
          <Link 
            to="/events" 
            className={`py-3 px-4 ${isActive('/events') ? 'text-tekOrange font-semibold' : ''} dark:text-gray-200 hover:bg-white/10 transition-colors rounded-md`}
            onClick={() => setIsMenuOpen(false)}
          >
            Events & Activities
          </Link>
          <Link 
            to="/projects" 
            className={`py-3 px-4 ${isActive('/projects') ? 'text-tekOrange font-semibold' : ''} dark:text-gray-200 hover:bg-white/10 transition-colors rounded-md`}
            onClick={() => setIsMenuOpen(false)}
          >
            Projects
          </Link>
          <Link 
            to="/blog" 
            className={`py-3 px-4 ${isActive('/blog') ? 'text-tekOrange font-semibold' : ''} dark:text-gray-200 hover:bg-white/10 transition-colors rounded-md`}
            onClick={() => setIsMenuOpen(false)}
          >
            Blog
          </Link>
