...
const Home = () => {
  ...
  // Update carouselImages to use proper paths
  ...
  return (
    <>
      <Helmet>
        <title>Tek Talent Africa - Tech Community Building Africa's Future</title>
        <meta name="description" content="A vibrant community of tech enthusiasts, developers and innovators building the future of technology in Africa." />
        <meta property="og:title" content="Tek Talent Africa - Tech Community" />
        <meta property="og:description" content="A vibrant community of tech enthusiasts, developers and innovators building the future of technology in Africa." />
        <meta property="og:image" content="/uploads/tektalentlogo.png" />
      ...
      <div className="min-h-screen bg-white dark:bg-gray-900">
        ...
        <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-32 pb-16">
          ...
          {/* Carousel images below the text - with opposite directions */}
